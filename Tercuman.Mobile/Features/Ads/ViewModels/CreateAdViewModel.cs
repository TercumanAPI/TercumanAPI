...
public partial class CreateAdViewModel : BaseViewModel
{
    ...
    [NotifyPropertyChangedFor(nameof(Step1LineColor), nameof(Step2LineColor))]
    ...
    [ObservableProperty] bool isRefreshing; // Toolkit standardına uyarlandı
    ...
    private async Task RefreshAsync()
    {
        ...
        try
        {
            // Formu temizlemek istersen form alanlarını boşaltabilirsin. 
            // Şimdilik çarkın dönmesi için 1 saniye gecikme simülasyonu uyguluyoruz.
            await Task.Delay(1000);

            // Eğer formu sıfırlasın istersen şu yorum satırlarını açabilirsin:
            // CurrentStep = 1;
